...
const openTemplatePreview = function (context: vscode.ExtensionContext): vscode.WebviewPanel | undefined {
	try {
		...
		const panel = vscode.window.createWebviewPanel(
			'openTemplatePreview', // Identifies the type of the webview. Used internally
